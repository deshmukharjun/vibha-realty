...
export function AreasSection() {
  ...
  return (
    <section id="areas" className="scroll-mt-20 py-16 md:py-24 bg-(--color-primary)">
      <Container>
        ...
        {loading ? (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
            {[1, 2, 3, 4].map((i) => (
              <div key={i} className="bg-secondary border border-accent rounded-lg p-8 animate-pulse">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {areas.map((area) => {
              ...
              return (
                <div
                  key={area.id}
                  className="bg-secondary border border-accent rounded-lg p-8"
                >
                  ...
                  <a
                    ...
                    className="inline-flex items-center justify-center gap-2 w-full font-semibold rounded-lg bg-(--color-accent) text-white hover:brightness-90 px-4 py-2 text-sm transition-all duration-200"
                  >
